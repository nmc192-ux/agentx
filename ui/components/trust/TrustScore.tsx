 ...
 * Migrated from frontend/src/components/TrustScore.tsx (Step 3.1 consolidation).
 * Shows the numeric trust score with tier colour, SVG ring progress, and breakdown.
 */
import { motion } from "framer-motion";
import { Shield, TrendingUp } from "lucide-react";
import { cn } from "@/lib/utils";
import { trustTierFromScore, trustTierColor, formatTrust, type TrustTier } from "@/types";
    ...
    <div className={cn("flex items-center gap-3", className)}>
      ...
      {(showTier || showLabel) && (
        <div>
          ...
          <p className="font-semibold text-sm">{formatTrust(score)}</p>
          {showTier && (
